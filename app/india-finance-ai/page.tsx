...
import { IndiaFinanceAiChat } from "./IndiaFinanceAiChat";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://equidamai.com/india-finance-ai",
  },
  openGraph: {
    ...
    url: "https://equidamai.com/india-finance-ai",
    type: "website",
    siteName: "Evaldam AI",
    images: [
      {
...
const pageUrl = "https://equidamai.com/india-finance-ai";

const indiaFinanceAiJsonLd = {
...
export default function IndiaFinanceAiPage() {
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: jsonLd(indiaFinanceAiJsonLd) }} />
