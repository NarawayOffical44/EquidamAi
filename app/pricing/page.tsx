...
const faqs = [
  ...
  { q: 'Is Evaldam Startup AI sold separately?', a: 'No. Evaldam Startup AI is included with Evaldam plans. Visitors and free dashboard accounts can try it with limited access, and paid plans include higher limits. The app notifies users when a limit is reached.' },
