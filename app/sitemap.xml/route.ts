...
const staticRoutes = [
  ...
  { path: "/pre-money-vs-post-money-valuation", changeFrequency: "monthly", priority: 0.82 },
  { path: "/startup-cap-table-valuation", changeFrequency: "monthly", priority: 0.82 },
  { path: "/safe-valuation-cap", changeFrequency: "monthly", priority: 0.82 },
  { path: "/term-sheet-valuation", changeFrequency: "monthly", priority: 0.82 },
  { path: "/409a-valuation", changeFrequency: "monthly", priority: 0.82 },
