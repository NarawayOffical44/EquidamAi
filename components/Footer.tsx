...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 26 26" className="h-4 w-4" fill="currentColor" aria-hidden="true">
            ...
            <div className="flex flex-wrap items-center gap-2">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-gray-200 bg-white text-gray-500 transition-colors hover:border-gray-400 hover:text-gray-900"
                >
                  {'icon' in link ? link.icon : <span className="text-xs font-black">{link.shortLabel}</span>}
                </a>
              ))}
