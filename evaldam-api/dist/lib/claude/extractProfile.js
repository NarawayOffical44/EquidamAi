...
exports.extractProfileFromPitchDeck = extractProfileFromPitchDeck;
const providers_1 = require("./providers");
async function extractProfileFromPitchDeck(pdfText, websiteUrl) {
...
Return ONLY this JSON (use null for any field not found):
{
  ...
  "overallConfidence": "number 0-100"
    ...
    const responseText = await (0, providers_1.callLLM)([{ role: "user", content: userPrompt }], { system: systemPrompt, useCase: "extraction", maxTokens: 2000 });
...
//# sourceMappingURL=extractProfile.js.map