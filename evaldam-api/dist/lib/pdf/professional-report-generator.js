...
exports.generatePDFReportHTML = generatePDFReportHTML;
exports.generatePDFFromHTML = generatePDFFromHTML;
const chart_generator_1 = require("./chart-generator");
function generatePDFReportHTML(result, profile) {
...
<div class="page page-break">
  ...
  ${(0, chart_generator_1.generateValuationRangeChart)(result.executiveSummary.blendedRange.low, result.executiveSummary.blendedRange.mid, result.executiveSummary.blendedRange.high, profile.companyName)}
...
<div class="page page-break">
  ...
  ${(0, chart_generator_1.generateMethodContributionChart)(result.methods.map((m) => ({
        name: m.methodName,
...
<div class="page page-break">
  ...
  ${(0, chart_generator_1.generateSensitivityChart)(result.blended.weightedAverage, result.sensitivityAnalysis.map((s) => ({
        scenario: s.scenario,
...
<div class="page">
  ...
  ${(0, chart_generator_1.generateValuationTrendsChart)()}

  <h2>Industry Benchmark Comparison</h2>
  ${(0, chart_generator_1.generateMarketBenchmarksChart)(profile.industry || 'saas')}
...
//# sourceMappingURL=professional-report-generator.js.map