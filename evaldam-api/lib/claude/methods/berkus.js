...
exports.BerkusMethod = void 0;
exports.berkusMethod = berkusMethod;
const base_method_1 = require("@/lib/claude/base-method");
class BerkusMethod extends base_method_1.ValuationMethodBase {
    constructor(profile) {
...
exports.BerkusMethod = BerkusMethod;
async function berkusMethod(profile) {
    return new BerkusMethod(profile).execute();
}
//# sourceMappingURL=berkus.js.map