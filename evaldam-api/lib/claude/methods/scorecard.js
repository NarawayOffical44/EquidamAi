...
exports.ScorecardMethod = void 0;
exports.scorecardMethod = scorecardMethod;
const base_method_1 = require("@/lib/claude/base-method");
class ScorecardMethod extends base_method_1.ValuationMethodBase {
    constructor(profile) {
...
exports.ScorecardMethod = ScorecardMethod;
async function scorecardMethod(profile) {
