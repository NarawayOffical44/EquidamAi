...
<div class="page" style="padding-top:56px;padding-bottom:56px;page-break-after:always;">
  ...
  <p style="font-size:13px;color:#64748b;margin-bottom:36px;">This report presents an indicative pre-money valuation of ${data.companyName} using ${(data.methods || []).filter(m => m?.methodName && m?.midEstimate).length} valuation method(s), stored assumptions, and available benchmark context.</p>
...
<div class="page" style="padding-top:56px;padding-bottom:56px;">
  ...
  <h2 style="font-size:28px;font-weight:800;color:#0f172a;margin-bottom:28px;">Data Sources & Report Statement</h2>
  ...
  <div style="background:linear-gradient(135deg,#0f172a,#1e1b4b);border-radius:16px;padding:40px;color:#fff;margin-top:24px;">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;">
      <div>
        ...
        <p style="font-size:13px;color:#94a3b8;max-width:400px;line-height:1.7;">
          ...
          using the valuation methods available in this report and benchmark context where available.
        </p>
      </div>
    ...
    <div style="border-top:1px solid rgba(255,255,255,.1);padding-top:24px;margin-bottom:24px;">
      <p style="font-size:12px;color:#e2e8f0;line-height:1.8;margin-bottom:12px;">
        <strong>Report statement:</strong> This report presents an indicative valuation analysis for <strong>${data.companyName}</strong>.
        Outputs are based on data provided by the client, stored method assumptions, and publicly
        available benchmark context as of ${today}. This is not a signed statutory valuation certificate.
      </p>
